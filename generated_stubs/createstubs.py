...
class Stubber:
    ...
    def get_obj_attributes(self, item_instance: object):
        ...
        for name in sorted(dir(item_instance)):
            try:
    ...
    def rename_package_modules(self, path=None):
        if path is None:
            path = self.path
    ...
    def write_object_stub(self, fp, object_expr: object, obj_name: str, indent: str, in_class: int = 0):
        ...
        if obj_name == "hub":
            ...
            items.append(("_button", "", "<class 'type'>", hub.button))
            items.append(("_display", "", "<class 'type'>", hub.display))
            items.append(("_motion", "", "<class 'type'>", hub.motion))
            items.append(("_port", "", "<class 'type'>", hub.port))
            items.append(("_sound", "", "<class 'type'>", hub.sound))
            items.append(("_supervision", "", "<class 'type'>", hub.supervision))
...
def main():
    ...
    extras = [
        "util",
        "util.adjust_motor_offset.lpf2",
        "util.adjust_motor_offset.lpf2.lpf2_logging",
        "util.adjust_motor_offset.lpf2.lpf2_motor_adjust",
        "util.adjust_motor_offset.lpf2.lpf2_motor_eeprom",
        "util.adjust_motor_offset.lpf2.lpf2_packet",
        "util.adjust_motor_offset.lpf2.lpf2_process",
        "util.adjust_motor_offset.AbsoluteMotorAdjust",
        "util.animations",
        "util.color",
        "util.constants",
        "util.error_handler",
        "util.ext_sensor_data",
        "util.log",
        "util.motion",
        "util.motor",
        "util.movement",
        ...
        "system.move",
        "system.movewrapper",
        "system.simplemotorwrapper",
        "system.simplemovewrapper",
        "system.sound",
        "version",
        #"ui",
        #"ui.hubui",
    ...
    stubber.rename_package_modules()
    #stubber.report()
